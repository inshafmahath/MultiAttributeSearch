...
public class CustomUserStoreManager {
    ...
    public UserListAttributes getMultiAttributeObject(String[] claims, String[] claimValues, String[] profileNames, int startAt, int endAt) throws UserStoreException {
        ...
        if (allUsers.length < endAt) {
            Arrays.copyOfRange(allUsers, startAt, allUsers.length);
        } else {
            Arrays.copyOfRange(allUsers, startAt, endAt);
        }

        UserListAttributes userListAttr = new UserListAttributes();
        userListAttr.setStartAt(startAt);
        userListAttr.setMaxResults(endAt);
        userListAttr.setTotal(allUsers.length);
    ...
    public UserListAttributes getMultiAttributeObjectWithFilter(String[] claims, String[] claimValues, String[] profileNames, String[] filterClaims, String[] filterClaimValues, String[] filterProfileNames, int startAt, int endAt) throws UserStoreException {
        ...
        if (claims.length != claimValues.length || claims.length != profileNames.length) {
            throw new UserStoreException(
                    "Claims, claim values and profile names consist of invalid length");
        } else if (filterClaims.length != filterClaimValues.length || filterClaims.length != filterProfileNames.length) {
            throw new UserStoreException(
            ...
            try {
                ...
                String[] userArray = getMultiAttributeUserList(claims, claimValues, profileNames);
